...
The specification (`conduit-protocol-spec.md`) is the source of truth for:
...
Conduit MUST integrate with the broader AI agent ecosystem:
...
**Rationale**: No protocol exists in isolation. Conduit fills the Human ↔ AI Agent
...
This constitution governs all Conduit Protocol development. Amendments require:
...
The specification (`conduit-protocol-spec.md`) is the normative reference.
