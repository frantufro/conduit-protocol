...
│                           │       │                                 │
│         ┌─────────────────┴─┐   ┌─┴─────────────────┐               │
│         │ Cauce Protocol  │   │  A2A Protocol     │               │
│         │ (native)          │   │  (integration)    │               │
│         └─────────────────┬─┘   └─┬─────────────────┘               │
│                           │       │                                 │
└───────────────────────────┼───────┼─────────────────────────────────┘
                            │       │
                   Cauce Agents   External A2A Agents
                   & Adapters
```
...
3. Hub converts the A2A message into a Cauce signal:
...
5. Your Cauce agent processes the signal and decides on response
...
| `WORKING` | Signal delivered to Cauce agent, awaiting response |
            ...
            "signal": {
              ...
              "payload": {
                "raw": {
                  ...
                  "summary": "A comparison of MCP, A2A, and Cauce..."
                }
              }
            }
          }
